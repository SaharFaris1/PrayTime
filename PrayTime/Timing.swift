...
class PrayerTimeViewModel: ObservableObject{
    @Published var prayerTimes: PrayerTimesResponse?
    var currentDate = ""
    ...
    func fetchPrayerTimes(){
        ...
        do{
            prayerTimes = try decoder.decode(PrayerTimesResponse.self, from: jsonData)
        }catch{
            print("Error: \(error)")
        }
    }
